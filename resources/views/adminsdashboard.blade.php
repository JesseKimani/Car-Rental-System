...
<button id="manageVehicles"/>
    <script>
      document.getElementById("manageVehicles").addEventListener("click", myFunction);
      function myFunction() {
        window.location.href="vehicles";
      }
    </script>Manage Vehicles</button>

<button id="manageClients"/>
    <script>
      document.getElementById("manageClients").addEventListener("click", myFunction);
      function myFunction() {
        window.location.href="clients";
      }
    </script>Manage Clients</button>
