        ...
        <div class="row">
            <div class="col-md-4 col-md-offset-4" style="margin-top:20px;">
                ...
                <form action="{{route('update-client')}}" method="post">
                    ...
                    <div class="alert alert-success">{{Session::get('client_update')}}</div>
                    @endif
                    @if(Session::has('fail'))
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="identity" value="{{$clients->identity}}">
                ...
                <div class="form-group">
                    ...
                    <input type="password" class="form-control" name="password" value="{{$clients->password}}">
