...
<button id="clientPortal"/>
    <script>
      document.getElementById("clientPortal").addEventListener("click", myFunction);
      function myFunction() {
        window.location.href="clientlogin";
      }
    </script>Client Portal</button>
...
<div class="container">
        <div class="row">
            <div class="col-md-4 col-md-offset-4" style="margin: 10px 40px 15px 14px;">
                <h4>Customers' Feedback</h4>
                <hr>

                @csrf
                 
                    @if(Session::has('feedback_delete'))
                    <div class="alert alert-success">{{Session::get('feedback_delete')}}</div>
                    @endif
                    ...
                    <table class="table">
                        ...
                        <th>ID</th>
                        <th>Name</th>
                        <th>Type of car hired</th>
                        <th>Problem(s) experienced</th>
                        <th>Rating(in a scale of 10)</th>
                    </tr>
