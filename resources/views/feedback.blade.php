...
<form action="{{ route('store-feedback') }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="form-group">
                ...
                <div class="form-group">
                    <label for="cartype">Type of car hired</label>
                    <input type="text" class="form-control" name="cartype">
                    
                </div>

                <div class="form-group">
                    <label for="problem">Any problem experienced? Specify if any</label>
                    <input type="text" class="form-control" name="problem" >
                    
                </div>

                <div class="form-group">
                    <label for="rating">How would you rate our services in a scale of 10</label>
